...
export default function Hero({data}) {
  ...
  return (
    ...
    >
      ...
      {/* Hero Content */}
      <div className="relative z-20 mx-auto md:mt-10 flex h-full w-full max-w-7xl flex-col items-start justify-center px-5">
        <div className="flex w-full flex-col gap-10 md:gap-16 md:max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <button className="inline-flex items-center gap-3 justify-center w-full md:w-fit md:min-w-60 px-6 py-4 text-base md:text-lg font-medium text-black bg-[#00f5d4] hover:bg-[#5bf5de] transition rounded-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-4 focus-visible:ring-[#00f5d4] focus-visible:ring-offset-[#00c8aa] disabled:opacity-30">
              <svg
              ...
              <a href="mailto:hello@epfdesk.com">See How It Works</a>
            </button>
          </div>

          <div className="flex items-center gap-4">
            <div className="h-1.5 w-1.5 bg-[#00f5d4]" />
